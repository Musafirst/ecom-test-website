  ...
  return (
    <footer className="bg-[#FAF7F2] px-3 pb-4 sm:px-4">
      <div className="mx-auto max-w-[1560px] rounded-[22px] border border-jamm-gold/20 bg-[#EDE8DC] px-6 py-16">
        <div className="flex w-full flex-col items-center justify-between gap-8 overflow-visible md:flex-row">
          <Link href="/shop" className="flex flex-shrink-0 items-center overflow-visible">
            <Image
              ...
              width={1536}
              height={1024}
              className="h-[146px] w-auto flex-shrink-0 object-contain md:h-[170px] lg:h-[195px]"
            />
          </Link>
