...
export function ComingSoonPage({ headline, subtext }: ComingSoonPageProps) {
  return (
    <section className="bg-[#FAF7F2] px-3 py-10 sm:px-4 lg:py-16">
      <motion.div
        className="mx-auto flex min-h-[calc(100vh-190px)] max-w-[1560px] items-center justify-center overflow-hidden rounded-[28px] bg-[#FAF7F2] px-6 py-16"
